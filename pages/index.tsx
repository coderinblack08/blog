...
export default function Home({ posts }: { posts: Post[] }) {
  ...
  return (
    <div className="tracking-tight">
      ...
      <div className="relative w-full">
        <div
          ...
          style={{
            position: "absolute",
            top: 0,
            left: `calc(${dimensions.x}px + 4rem)`,
          }}
        >
          <CustomDashedBorder
            left={{
        ...
        <div
          className="max-w-[58rem] mx-auto h-24 px-20 py-4"
        ...
        <div className="max-w-[58rem] mx-auto flex items-center space-x-3 px-20 py-4">
          <div className="relative">
            <div className="absolute left-8 -top-16 w-64 font-pen text-[2rem] text-gray-500 font-medium select-none">
              <img
                src="arrow-down.svg"
                alt="Down Arrrow"
                aria-hidden
            ...
            <a
              ...
              className="select-none flex items-center space-x-2 px-6 py-2.5 rounded-xl text-2xl font-semibold border-2 border-gray-300 focus:outline-none focus:ring focus:ring-offset-4 focus:ring-offset-gray-100 focus:ring-purple"
            >
        ...
        <div className="max-w-[58rem] mx-auto space-y-8 px-20 py-10">
          ...
          <h2 className="text-gray-600 font-semibold text-3xl leading-tight">
        ...
        <div className="max-w-[58rem] mx-auto text-xl px-20 py-4">
      ...
      <div className="w-full border-t border-gray-300 dotted-background px-8 py-24 font-medium text-lg overflow-y-auto h-screen">
        <div className="max-w-[58rem] mx-auto">
          <h3 className="select-none">
            ...
            "
            <button className="ml-2 inline px-2 rounded bg-cyan text-gray-100">
              side-projects
            </button>
